...
class Game {
    ...
    setupUpgrades() {
        this.upgrades = [
            ...
            new UpgradeInfo(Upgrade.DoubleAdders2, 20000, 'Even better Adders', 'Doubles the points given to adjacent incrementors.', '2', UpgradeEffect.DoubleAdders, Upgrade.DoubleAdders2),
            new UpgradeInfo(Upgrade.DoubleAdders3, 200000, 'Even even better Adders', 'Doubles the points given to adjacent incrementors.', '2', UpgradeEffect.DoubleAdders, Upgrade.DoubleAdders3),
            new UpgradeInfo(Upgrade.DoubleAdders4, 2000000, 'Mega Adders', 'Doubles the points given to adjacent incrementors.', '2', UpgradeEffect.DoubleAdders, Upgrade.DoubleAdders4),
